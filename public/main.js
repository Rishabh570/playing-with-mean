...
/* harmony import */ var _guard_guard_guard__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./guard/guard.guard */ "./src/app/guard/guard.guard.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var appRoutes = [
    ...
    { path: 'dashboard', component: _components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_8__["DashboardComponent"], canActivate: [_guard_guard_guard__WEBPACK_IMPORTED_MODULE_15__["GuardGuard"]] },
    { path: 'profile', component: _components_profile_profile_component__WEBPACK_IMPORTED_MODULE_11__["ProfileComponent"], canActivate: [_guard_guard_guard__WEBPACK_IMPORTED_MODULE_15__["GuardGuard"]] }
];
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_services_validate_service__WEBPACK_IMPORTED_MODULE_12__["ValidateService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_13__["AuthService"], _guard_guard_guard__WEBPACK_IMPORTED_MODULE_15__["GuardGuard"]],
...
module.exports = "<div class=\"jumbotron text-center\">\n  <h1>MEAN Authentication App</h1>\n  <p class=\"lead\">Welcome</p>\n  <div>\n    <a class=\"btn btn-outline-danger mr-3 btn-lg\" [routerLink]=\"['/register']\" >Register</a>\n    <a class=\"btn btn-outline-secondary btn-lg\" [routerLink]=\"['/login']\" >Login</a>\n  </div>\n</div>\n\n"
...
module.exports = "<div class=\"d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-dark border-bottom box-shadow\">\n    <h5 class=\"my-0 mr-md-auto font-weight-normal\">MEAN Auth App</h5>\n    <nav class=\"my-2 my-md-0 mr-md-3\">\n      <ul class=\"nav navbar\">\n        <li class=\"btn btn-debug\" *ngIf=\"authService.loggedIn()\" [routerLinkActive]=\"['active']\"><a class=\"p-2 mr-2 text-dark\" [routerLink]=\"['/dashboard']\" style=\"text-decoration: none;\">Dashboard</a></li>\n        <li class=\"btn btn-debug\" *ngIf=\"authService.loggedIn()\" [routerLinkActive]=\"['active']\"><a class=\"p-2 mr-2 text-dark\" [routerLink]=\"['/']\" style=\"text-decoration: none;\">Home</a></li>\n        <li class=\"btn btn-debug\" *ngIf=\"authService.loggedIn()\" [routerLinkActive]=\"['active']\"><a class=\"p-2 mr-2 text-dark\" [routerLink]=\"['/profile']\" style=\"text-decoration: none;\">Profile</a></li>\n        <li class=\"btn btn-debug\" *ngIf=\"!authService.loggedIn()\" [routerLinkActive]=\"['active']\"><a class=\"p-2 mr-2 text-dark\" [routerLink]=\"['/login']\" style=\"text-decoration: none;\">Login</a></li>\n        <li class=\"btn btn-debug\" *ngIf=\"!authService.loggedIn()\" [routerLinkActive]=\"['active']\"><a class=\"p-2 mr-2 text-dark\" [routerLink]=\"['/register']\" style=\"text-decoration: none;\">Register</a></li>\n        <li class=\"btn btn-debug\" *ngIf=\"authService.loggedIn()\" ><a href=\"#\" (click)=\"onLogoutClick()\" style=\"text-decoration: none;\">Logout</a> </li>\n      </ul>\n    </nav>\n</div>\n"
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(validateService, _flashMessage, authService, router) {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        if (!this.validateService.validateEmail(user.email)) {
            this._flashMessage.show('Please fill in a valid email', { cssClass: 'alert-danger', timeout: 3000 });
            return false;
        }
        // Register User
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this._flashMessage.show('You are now registered! You can Log In now :)', { cssClass: 'alert-success', timeout: 3000 });
                _this.router.navigate(['/login']);
            }
            else {
                _this._flashMessage.show('Something went Wrong :(', { cssClass: 'alert-success', timeout: 3000 });
...
var GuardGuard = /** @class */ (function () {
    function GuardGuard(authService, router) {
        this.authService = authService;
        this.router = router;
    }
...
module.exports = __webpack_require__(/*! C:\Users\rishabh\playing-with-mean\front-end\src\main.ts */"./src/main.ts");
